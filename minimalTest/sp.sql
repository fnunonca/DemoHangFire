...
BEGIN
    ...
    WHERE RTRIM(descripcion) = 'DiasVal_PAut_Conf'
END
...
BEGIN
    ...
    WHERE RTRIM(descripcion) = 'DiasVal_Aut_Devol'
END
-- Transacciones depositadas (circuito cerrado)            
ELSE IF @Accion = 'CLOSED'
BEGIN
    SELECT @TipoP1 = 'DP'
    SELECT @TipoP2 = 'DP'
    SELECT @TipoP3 = 'DP'
...
BEGIN
    ...
    SELECT @Status3 = 'DV'
    SELECT @Status4 = 'DV'
    SELECT @timeout = 365 -- Realmente no hay limite para reporte de devueltas            
END
